# SkyConnect Group of Airlines — Business Intelligence Dashboard
 ...
 **Key Insight:** Revenue dropped from ₦272M (2023) → ₦250M (2024), confirming the gross profit decline noted in project notes. Profit margin held steady at 23.1%, meaning the drop was volume-driven, not a cost efficiency issue.
...
**66.8% on-time rate** — nearly 1 in 3 flights was either delayed or cancelled |
**Weather is the costliest delay driver** at an average of 145 minutes, followed by Air Traffic Control (138 min) |
**Lagos → Nairobi** is the top-grossing route at ₦13.3M revenue |
...
###  Operational Efficiency (Delay & Cancellation Reduction)
